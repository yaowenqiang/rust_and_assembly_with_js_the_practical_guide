...
export function calculate_circle_area(radius: number): number;
...
export function sum_array(numbers: Int32Array): number;
...
export interface InitOutput {
    ...
    readonly calculate_circle_area: (a: number) => number;
