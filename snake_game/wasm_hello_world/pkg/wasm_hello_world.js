/* @ts-self-types="./wasm_hello_world.d.ts" */
 ...
 * @returns {number}
 */
export function add_numbers(a, b) {
    const ret = wasm.add_numbers(a, b);
    return ret;
}
...
export function calculate_circle_area(radius) {
    const ret = wasm.calculate_circle_area(radius);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./wasm_hello_world_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wasm_hello_world_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
